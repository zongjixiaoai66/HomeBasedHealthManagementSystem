        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="健康指标" prop="jiankangTypes">
                        <el-select v-model="ruleForm.jiankangTypes" :disabled="ro.jiankangTypes" placeholder="请选择健康指标">
                            <el-option
