        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.jiashuPhoto" label="头像" prop="jiashuPhoto">
                        <file-upload
                            tip="点击上传头像"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.jiashuPhoto" label="头像" prop="jiashuPhoto">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="联系方式" prop="jiashuPhone">
                       <el-input v-model="ruleForm.jiashuPhone"
                                 placeholder="联系方式" clearable  :readonly="ro.jiashuPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="联系方式" prop="jiashuPhone">
                           <el-input v-model="ruleForm.jiashuPhone"
                                     placeholder="联系方式" readonly></el-input>
                       </el-form-item>
                   </div>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="电子邮箱" prop="jiashuEmail">
                       <el-input v-model="ruleForm.jiashuEmail"
                                 placeholder="电子邮箱" clearable  :readonly="ro.jiashuEmail"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="电子邮箱" prop="jiashuEmail">
                           <el-input v-model="ruleForm.jiashuEmail"
                                     placeholder="电子邮箱" readonly></el-input>
                       </el-form-item>
                   </div>
