    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='yonghu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="健康指标" prop="jiankangValue">
                        <el-input v-model="yonghuForm.jiankangValue"
                                  placeholder="健康指标" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="健康指标" prop="jiankangValue">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="档案标题" prop="jiankangdanganName">
                       <el-input v-model="ruleForm.jiankangdanganName"
                                 placeholder="档案标题" clearable  :readonly="ro.jiankangdanganName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="档案标题" prop="jiankangdanganName">
                           <el-input v-model="ruleForm.jiankangdanganName"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="档案类型" prop="jiankangdanganTypes">
                        <el-select v-model="ruleForm.jiankangdanganTypes" :disabled="ro.jiankangdanganTypes" placeholder="请选择档案类型">
                            <el-option
                                v-for="(item,index) in jiankangdanganTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="档案类型" prop="jiankangdanganValue">
                        <el-input v-model="ruleForm.jiankangdanganValue"
                            placeholder="档案类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.jiankangdanganFile" label="档案下载" prop="jiankangdanganFile">
                        <file-upload
                                tip="点击上传档案下载"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.jiankangdanganFile?$base.url+ruleForm.jiankangdanganFile:''"
                                @change="jiankangdanganFileUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.jiankangdanganFile" label="档案下载" prop="jiankangdanganFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.jiankangdanganFile"  >档案下载下载</a>
                        </el-form-item>
                    </div>
                </el-col>
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="档案详情" prop="jiankangdanganContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.jiankangdanganContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.jiankangdanganContent" label="档案详情" prop="jiankangdanganContent">
                            <span v-html="ruleForm.jiankangdanganContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                yonghuForm: {},
                ro:{
                    jiankangdanganName: false,
                    jiankangdanganTypes: false,
                    jiankangdanganFile: false,
                    yonghuId: false,
                    jiankangdanganContent: false,
                    jiankangdanganDelete: false,
                    insertTime: false,
                },
                ruleForm: {
                    jiankangdanganName: '',
                    ...
                    jiankangdanganFile: '',
                    yonghuId: '',
                    jiankangdanganContent: '',
                    jiankangdanganDelete: '',
                    insertTime: '',
                },
                jiankangdanganTypesOptions : [],
                yonghuOptions : [],
                rules: {
                   jiankangdanganName: [
                   ...
                   jiankangdanganFile: [
                              { required: true, message: '档案下载不能为空', trigger: 'blur' },
                          ],
                   yonghuId: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=jiankangdangan_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.jiankangdanganTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.jiankangdanganContent = _this.ruleForm.jiankangdanganContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.jiankangdanganContent = this.ruleForm.jiankangdanganContent.replaceAll(this.$base.url,"");
                        this.$http({
            ...
            //图片
            jiankangdanganFileUploadChange(fileUrls){
                this.ruleForm.jiankangdanganFile = fileUrls;
                this.addEditUploadStyleChange()
            },
