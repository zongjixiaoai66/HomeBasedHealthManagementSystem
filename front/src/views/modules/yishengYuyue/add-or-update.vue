    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='yisheng' ">
                    <el-form-item class="input" v-if="type!='info'"  label="预约须知" prop="yishengGuahao">
                        <el-input v-model="yishengForm.yishengGuahao"
                                  placeholder="预约须知" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="预约须知" prop="yishengGuahao">
                            <el-input v-model="ruleForm.yishengGuahao"
                                      placeholder="预约须知" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='yisheng' ">
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="预约备注" prop="yishengYuyueText">
                        <el-input type="textarea"  :readonly="ro.yishengYuyueText" v-model="ruleForm.yishengYuyueText" placeholder="预约备注"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yishengYuyueText" label="预约备注" prop="yishengYuyueText">
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.yishengYuyueYesnoTypes" label="预约审核" prop="yishengYuyueYesnoTypes">
                        <el-input v-model="ruleForm.yishengYuyueYesnoValue" placeholder="预约审核" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.yishengYuyueYesnoText" label="审核结果" prop="yishengYuyueYesnoText">
