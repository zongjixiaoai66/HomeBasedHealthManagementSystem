    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">智慧社区居家养老健康管理系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <el-form-item label="联系方式" class="input" v-if="tableName=='jiashu'">
                            <el-input v-model="ruleForm.jiashuPhone" autocomplete="off" placeholder="联系方式"  />
                        </el-form-item>
                        <el-form-item label="电子邮箱" class="input" v-if="tableName=='jiashu'">
                            <el-input v-model="ruleForm.jiashuEmail" autocomplete="off" placeholder="电子邮箱"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            //// 家属 的 老人
                            // if((!this.ruleForm.yonghuId)&& 'jiashu'==this.tableName){
...
.container {
    ...
    background-repeat: no-repeat;
        background-image: url(/zhihuishequjujiayanglaojiankang/img/back-img-bg.jpg);
